...
void new_euclid_edge(u,v)
  Vertex *u,*v;
@y
void new_euclid_edge(Vertex *u,Vertex *v)
@z
...
@y
long sign_test(long x1,long x2,long x3,long y1,long y2,long y3)
@z
...
long ccw(u,v,w)
  Vertex *u,*v,*w;
@y
long ccw(Vertex *u,Vertex *v,Vertex *w)
@z

@x l.474
long incircle(t,u,v,w)
  Vertex *t,*u,*v,*w;
@y
long incircle(Vertex *t,Vertex *u,Vertex *v,Vertex *w)
@z
...
long ff(t,u,v,w)
  Vertex *t,*u,*v,*w;
@y
long ff(Vertex *t,Vertex *u,Vertex *v,Vertex *w)
@z
...
long gg(t,u,v,w)
  Vertex *t,*u,*v,*w;
@y
long gg(Vertex *t,Vertex *u,Vertex *v,Vertex *w)
@z
...
long hh(t,u,v,w)
  Vertex *t,*u,*v,*w;
@y
long hh(Vertex *t,Vertex *u,Vertex *v,Vertex *w)
@z
...
long jj(t,u,v,w)
  Vertex *t,*u,*v,*w;
@y
long jj(Vertex *t,Vertex *u,Vertex *v,Vertex *w)
@z

@x l.882
void flip(c,d,e,t,tp,tpp,p,xp,xpp)
  arc *c,*d,*e;
  Vertex *t,*tp,*tpp,*p;
  node *xp,*xpp;
@y
void flip(arc *c,arc *d,arc *e,@|
...
void new_mile_edge(u,v)
  Vertex *u,*v;
@y
void new_mile_edge(Vertex *u,Vertex *v)
@z
